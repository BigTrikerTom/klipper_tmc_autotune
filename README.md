...
```bash
wget -O - https://raw.githubusercontent.com/BigTrikerTom/klipper_tmc_autotune/main/install.sh | bash
```
...
origin: https://github.com/BigTrikerTom/klipper_tmc_autotune.git
